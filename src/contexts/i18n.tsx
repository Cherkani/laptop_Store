...
const dictionaries: Record<Locale, Dict> = {
  en: {
    ...
    'admin.group.pilotage': 'Insights',
    'admin.group.commercial': 'Sales',
    'admin.group.crm': 'Contacts',
    'admin.group.catalog': 'Product Operations',
    'admin.group.settings': 'Settings',
    'admin.nav.dashboard': 'Dashboard',
    'admin.nav.daily': 'Daily Check',
    ...
    'admin.nav.cashSales': 'Cash Sales',
  ...
  fr: {
    ...
    'admin.group.pilotage': 'Analyse & rapports',
    'admin.group.commercial': 'Commercial',
    'admin.group.crm': 'Contacts',
    'admin.group.catalog': 'Opérations produits',
    'admin.group.settings': 'Paramètres',
    'admin.nav.dashboard': 'Dashboard',
    'admin.nav.daily': 'Vérification du jour',
    ...
    'admin.nav.clients': 'Clients',
    'admin.nav.companies': 'Entreprises',
    'admin.nav.suppliers': 'Fournisseurs',
    'admin.nav.cashSales': 'Ventes cash',
