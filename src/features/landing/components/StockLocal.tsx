          ...
          <div className="grid lg:grid-cols-2 lg:items-stretch">
            ...
            >
              ...
              <div className="absolute inset-0 z-[3]">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[#0f1726]/80 lg:block hidden" />
              </div>
              {/* Layered images desktop only */}
              <div className="absolute bottom-6 right-6 z-[4] hidden flex-col gap-2 lg:flex">
                <div className="h-24 w-36 overflow-hidden rounded-xl border border-white/10 shadow-xl opacity-80">
                  <img
                ...
                <div className="h-20 w-32 overflow-hidden rounded-xl border border-white/10 shadow-xl opacity-50 self-end">
                  <img
            ...
            <ScrollReveal delay={100} className="flex flex-col justify-center p-8 lg:p-12">
              ...
              <Link
                to="/products"
                className="mt-8 inline-flex w-fit items-center gap-2 rounded-2xl bg-emerald-500 px-7 py-3.5 text-sm font-bold text-white shadow-lg shadow-emerald-500/25 transition-all duration-200 hover:-translate-y-0.5 hover:bg-emerald-400 hover:shadow-emerald-400/35 active:scale-95"
              >
                Acheter maintenant
