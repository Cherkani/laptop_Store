...
const SLIDES = [
  {
    ...
    sub: 'Testés, garantis et expédiés depuis le Maroc. Prix nets, sans mauvaises surprises.',
  ...
  },
  {
    ...
    sub: 'MacBook Air, MacBook Pro — garantis, expédiés rapidement partout au Maroc.',
  ...
  return (
    <div className="max-w-2xl">
      ...
      <div className="mt-8 flex flex-wrap gap-3" style={anim(270)}>
        <Link
          to={slide.cta.to}
          className="group inline-flex items-center gap-2 rounded-2xl bg-amber-500 px-7 py-3.5 text-sm font-bold text-on-primary shadow-xl shadow-amber-500/40 transition-all duration-300 hover:-translate-y-1 hover:bg-amber-400 hover:shadow-amber-400/50 active:scale-95"
        >
          {slide.cta.label}
